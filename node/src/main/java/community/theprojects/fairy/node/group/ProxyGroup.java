...
public record ProxyGroup(String id, String name, String description, int minimumMemory, int maximumMemory,
                         int maxPlayers, boolean staticServices, ProxyType proxyType, JavaVersion javaVersion,
