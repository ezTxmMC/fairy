...
public class ServerGroup implements IGroup, IConfig {
    ...
    public ServerGroup(String id, String name, String description, int minimumMemory, int maximumMemory, int maxPlayers, boolean staticServices, ServerType serverType, JavaVersion javaVersion, IGroupTemplate groupTemplate) {
        this.id = id;
        this.name = name;
